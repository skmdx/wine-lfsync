...
extern void x11drv_window_paint_ready( UINT64 identity );
...
enum x11drv_window_messages
{
    ...
    WM_X11DRV_WINDOW_PAINT_READY,
    WM_X11DRV_SURFACE_FLUSH_READY
};
...
struct x11drv_win_data
{
    ...
    SIZE           client_surface_backing_shrink_size;
...
struct x11drv_native_window_read
{
    ...
    struct x11drv_error_handler errors, copy_errors;
    struct x11drv_stream_barrier geometry, drawing, copy;
    Display *display;
