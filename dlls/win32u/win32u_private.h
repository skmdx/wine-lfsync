...
extern DWORD get_window_client_surface_flags( HWND hwnd );
...
extern BOOL window_surface_flush( struct window_surface *surface );
extern void cleanup_window_paints( HWND hwnd );
struct window_paint;
extern struct window_paint *begin_window_paint( HWND hwnd );
extern void end_window_paint( struct window_paint *paint, BOOL success );
...
extern BOOL map_window_rects_virt_to_raw_batch( UINT count, struct window_rects *rects, const struct ratio *dpis );
...
extern void client_surface_publish_window( HWND hwnd );
