...
enum wine_internal_message
{
    ...
    WM_WINE_UPDATECLIENTSURFACE,
    WM_WINE_DESTROYCLIENTSURFACE,
...
#define WINE_PREPARE_CLIENT_SURFACES 5
#define WINE_UPDATE_CLIENT_SURFACE_HANDOFFS 6
#define WINE_RESOLVE_CLIENT_SURFACE_SOURCES 7
