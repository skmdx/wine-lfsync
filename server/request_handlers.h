...
C_ASSERT( offsetof(struct set_client_surface_state_request, generation) == 28 );
C_ASSERT( sizeof(struct set_client_surface_state_request) == 32 );
...
C_ASSERT( sizeof(struct set_client_surface_state_reply) == 16 );
