...
C_ASSERT( offsetof(struct get_visible_region_reply, scene_toplevel) == 52 );
C_ASSERT( offsetof(struct get_visible_region_reply, scene_generation) == 56 );
C_ASSERT( sizeof(struct get_visible_region_reply) == 64 );
...
C_ASSERT( offsetof(struct get_update_region_request, expected_child) == 20 );
C_ASSERT( offsetof(struct get_update_region_request, flags) == 24 );
C_ASSERT( sizeof(struct get_update_region_request) == 32 );
...
C_ASSERT( offsetof(struct get_job_info_reply, limit_flags) == 16 );
C_ASSERT( sizeof(struct get_job_info_reply) == 24 );
...
C_ASSERT( offsetof(struct set_client_surface_state_reply, scene_generation) == 24 );
...
C_ASSERT( offsetof(struct set_client_surface_state_reply, mode) == 52 );
C_ASSERT( offsetof(struct set_client_surface_state_reply, active) == 56 );
C_ASSERT( offsetof(struct set_client_surface_state_reply, cached) == 60 );
...
C_ASSERT( offsetof(struct get_client_surface_handoff_event_request, handle) == 12 );
C_ASSERT( offsetof(struct get_client_surface_handoff_event_request, producer) == 16 );
C_ASSERT( offsetof(struct get_client_surface_handoff_event_request, surface) == 24 );
C_ASSERT( offsetof(struct get_client_surface_handoff_event_request, cookie) == 32 );
C_ASSERT( offsetof(struct get_client_surface_handoff_event_request, owner) == 40 );
...
C_ASSERT( offsetof(struct complete_client_surface_handoffs_request, handle) == 12 );
C_ASSERT( offsetof(struct complete_client_surface_handoffs_request, generation) == 16 );
C_ASSERT( offsetof(struct complete_client_surface_handoffs_request, scene_generation) == 24 );
C_ASSERT( sizeof(struct complete_client_surface_handoffs_request) == 32 );
C_ASSERT( offsetof(struct complete_client_surface_handoffs_reply, accepted) == 8 );
C_ASSERT( sizeof(struct complete_client_surface_handoffs_reply) == 16 );
C_ASSERT( offsetof(struct cancel_client_surface_handoffs_request, handle) == 12 );
C_ASSERT( offsetof(struct cancel_client_surface_handoffs_request, generation) == 16 );
C_ASSERT( offsetof(struct cancel_client_surface_handoffs_request, scene_generation) == 24 );
C_ASSERT( sizeof(struct cancel_client_surface_handoffs_request) == 32 );
...
C_ASSERT( offsetof(struct prepare_client_surface_direct_plan_request, previous_scene) == 32 );
C_ASSERT( sizeof(struct prepare_client_surface_direct_plan_request) == 40 );
...
C_ASSERT( offsetof(struct request_client_surface_owner_repair_reply, accepted) == 8 );
C_ASSERT( sizeof(struct request_client_surface_owner_repair_reply) == 16 );
C_ASSERT( offsetof(struct resolve_client_surface_scene_sources_request, handle) == 12 );
C_ASSERT( offsetof(struct resolve_client_surface_scene_sources_request, scene_id) == 16 );
C_ASSERT( sizeof(struct resolve_client_surface_scene_sources_request) == 24 );
C_ASSERT( offsetof(struct resolve_client_surface_scene_sources_reply, accepted) == 8 );
C_ASSERT( sizeof(struct resolve_client_surface_scene_sources_reply) == 16 );
