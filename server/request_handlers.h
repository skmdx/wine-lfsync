...
C_ASSERT( sizeof(struct set_client_surface_state_request) == 40 );
...
C_ASSERT( offsetof(struct set_client_surface_state_reply, pending) == 24 );
C_ASSERT( offsetof(struct set_client_surface_state_reply, staged) == 28 );
